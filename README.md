...
| **Discoverability**      | `keepup list`, `keepup validate`, and `keepup graph` (Mermaid diagram of the data DAG). `run`/`watch`/`graph` tab-complete flow names, with descriptions, from the config on the command line. |
